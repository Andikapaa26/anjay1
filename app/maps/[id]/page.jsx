  ...
  return data ? (
    <>
      ...
      <div className="mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10">
        ...
        <p className='my-3'>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero error asperiores fuga, sunt
          consequatur saepe earum dignissimos quod nostrum doloribus suscipit id iste commodi deserunt
          assumenda iusto? Reiciendis sequi est et sed!
        </p>
